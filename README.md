...
|--------------|-------------|------------|
| 🎓 [College Website (Live Production)](spcpgcollege.in) | A **real-world**, actively used college platform with **Admin Panel**, Google Authentication via Firebase, OTP-based email verification, password reset, image upload (Cloudinary + Multer), and high Google search ranking | React.js, Node.js, Express.js, MongoDB, JWT, Firebase Auth, Cloudinary, Multer, HTML, CSS, Tailwind CSS |
